...
const FormularioTema = ({ cerrarFormulario, fetchTemas }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost:8080/api/admin/agregar-tema", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md w-full max-w-lg mx-4">
      <div className="flex justify-between items-center p-3 border-b">
        <h2 className="text-lg font-bold">Agregar Nuevo Tema</h2>
        <button 
